...
try:
    ...
    if not df_diego.empty:
        df_diego[['HORA_INI_STR', 'HORA_FIN_STR']] = df_diego['Hora inicio'].str.split(' - ', expand=True) # expand=True crea dos columnas
        ...
        df_diego = df_diego.drop(columns=['HORA_INI_STR', 'HORA_FIN_STR', 'Hora inicio'])
